...
//typedef is specific to FgameplayAttribute signature, but TStaticFunPtr is generic to any signature chosen
...
public:
	...
	//This is the fucntion we need to replicate anu variables
	virtual void GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const override;

	//This funciton is needed to manage attribute clamping
	...
	//We create this function to replace the delagates we need to associate with each attribute
	...
	// Resistance attributes Attributes_Resistance_Arcane
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_ResistanceArcane, Category="Resistance Attributes")
	FGameplayAttributeData ArcaneResistance;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet,ArcaneResistance);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_ResistanceLighting, Category="Resistance Attributes")
